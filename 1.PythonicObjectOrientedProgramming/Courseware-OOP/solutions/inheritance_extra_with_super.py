...
[Note: super() will be explained later in Pythonic OOP. But if you know about
it already, this is an alternative solution that uses it. If you are not
already familiar with super(), focus on the regular solution for now.]
